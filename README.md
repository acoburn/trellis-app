...
| Name | Default | Description |
| ---- | ------- | ----------- |
| async | false | Whether resource caches should be generated by an async processor. **Note**: setting this to `true` will make write operations faster for clients, but the availability of the updated content will appear to lag (because it is generated asynchronously). |
